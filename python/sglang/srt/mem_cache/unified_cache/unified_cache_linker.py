...
class UnifiedCacheLinkerWrapper:
    ...
    def __init__(
        ...
        if (
            ...
            raise ValueError("SWA retention interval must be nonnegative and page aligned")
        ...
        if self.swa_retention_interval and logger.isEnabledFor(logging.DEBUG):
            ...
            checkpoint_keys = [
                (
                    ...
                    tail_hashes[
                        (start - device_hit_len) // page :
                        (end - device_hit_len) // page
                    ],
                )
    ...
    def offload_nodes(
        ...
        *,
        ...
        cache = self.cache
        refresh_windows = bool(self.swa_retention_interval and replay_boundary is not None)
        pending_node_ids = [
            node_id
