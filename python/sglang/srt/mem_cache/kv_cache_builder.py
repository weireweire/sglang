...
def _maybe_create_decode_storage_contributor(server_args: ServerArgs, params) -> object:
...
def build_kv_cache(
    *,
    ...
    storage_contributor = _maybe_create_decode_storage_contributor(server_args, params)
